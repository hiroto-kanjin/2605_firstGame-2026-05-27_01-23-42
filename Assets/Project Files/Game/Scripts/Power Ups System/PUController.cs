...
namespace Watermelon
{
    ...
    public class PUController : MonoBehaviour
    {
        ...
        public void Init()
        {
            ...
            PowerUpsRemoteConfigData overrideData = RemoteConfigController.TryGetConfig<PowerUpsRemoteConfigData>("powerUps");
            ...
            for (int i = 0; i < ActivePowerUps.Length; i++)
            {
                ...
                settings.InitialiseSave(overrideData?.GetPowerUp(settings.Type));
                settings.Init();
